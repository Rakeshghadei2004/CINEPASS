...
const Navbar = () => {
  ...
  }, [isMenuOpen]); //it will open the menu for smaller screen and also closes the escape key enterted
    ...
    <nav className={`${navbarStyles.nav.base} ${isScrolled ? navbarStyles.nav.scrolled : navbarStyles.nav.notScrolled
      ...
      <div className={navbarStyles.container}>
        <div className={navbarStyles.logoContainer}>
          ...
          <div className={navbarStyles.logoText}>CinePass </div>
        </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <div key={item.id} className={navbarStyles.desktopNavItem}>
                  <NavLink to={item.path} end className={({ isActve }) =>
                    `${navbarStyles.desktopNavLink.base} ${isActve ? navbarStyles.desktopNavLink.active :
        ...
        <div className={navbarStyles.rightSection}>
          <div className={navbarStyles.tabletNav}>
            {navItems.map((item) => {
              const Icon = item.icon;
              return (
                <NavLink key={item.id} to={item.path} end className={({ isActve }) =>
                  `${navbarStyles.tabletNavLink.base} ${isActve ? navbarStyles.tabletNavLink.active
        ...
        {isMenuOpen && (
          <div ref={menuRef} className={navbarStyles.mobileMenuPanel}>
            <div className={navbarStyles.mobileMenuItems}>
              ...
              const Icon = item.icon;
              return (
                <NavLink key={item.id} to={item.path} end onClick={() => setIsMenuOpen(false)}
                className={({ isActve }) =>
                  `${navbarStyles.mobileNavLink.base} ${isActve ? navbarStyles.mobileNavLink.active
