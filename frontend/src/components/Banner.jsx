            ...
            <div className={bannerStyles.content}>
                <div className={bannerStyles.contentInner}>
                    ...
                    <p className={bannerStyles.description}>
                        An epic adventure beneath the waves. explore the mysteries of the deep ocean and discover treasures beyond imagination in this breathtaking cinematic expericence .
