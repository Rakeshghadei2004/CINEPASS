            ...
            <div className={contactStyles.contentContainer}>
                <div className={contactStyles.headerContainer}>
                    <div className='inline-flex items-center justify-center mb-1'>
                        <h4 className={contactStyles.headerTitle}>
                    ...
                    <p className={contactStyles.headerSubtitle}>
                        Have questions  about movie bookings or special events? Our team is hear to help you
                    </p>
                </div>
                            ...
                            <form onSubmit={handleSubmit} className={contactStyles.form}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        pattern='[0-9]{10}'
                                        maxLength={10}
                                        title='Enter a 10digit phone number'
                                        className={contactStyles.input}
                                ...
                                <div className={contactStyles.contactInfo}>
                                    <div className={contactStyles.contactItem}>
                                        <div className={contactStyles.contactIconContainer}>
                                            <Phone className={contactStyles.contactText} />
                                        </div>
                                        <div>
                                    ...
                                    <div className={contactStyles.contactItem}>
                                        <div className={contactStyles.contactIconContainer}>
                                            <Mail className={contactStyles.contactText} />
                                        </div>
                                        <div>
                                            <h3 className={contactStyles.contactText}>
                                                Email Address
                                     ...
                                     <div className={contactStyles.contactItem}>
                                        <div className={contactStyles.contactIconContainer}>
                                            <MapPin className={contactStyles.contactText} />
                                        </div>
                                        <div>
                                            <h3 className={contactStyles.contactText}>
                                            ...
                                            <p className={contactStyles.contactDetail}>
                                               123 cinema street , film city, bhubaneswar
                                            </p>
                                            <p className={contactStyles.contactDetail}>
