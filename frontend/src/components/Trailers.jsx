...
const Trailers = () => {
    ...
    //this function helps to show the selected trailer
                            ...
                            <div className={trailersStyles.videoContainer}>
                                {isPlaying ? (
                                    ...
                                    <div className={trailersStyles.thumbnailContainer}>
                                        <img src={featuredTrailer?.thumbnail || PLACEHOLDER_THUMB} alt={featuredTrailer?.title} className={trailersStyles.thumbnailImage} loading='eager' />
