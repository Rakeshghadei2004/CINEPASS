        ...
        try {
            ...
            if (data && data.success) {
                ...
                try {
                    ...
                    console.warn("Failed To Persists full user obj");
                }
            ...
            <div className='relative w-full max-w-md z-10'>
                <div className={loginStyles.backButtonContainer}>
                    <button onClick={goBack} className={loginStyles.backButton}>
                        <ArrowLeft size={16} className={loginStyles.backButtonIcon} />
                    ...
                    <div className={loginStyles.cardContent}>
                        <div className={loginStyles.headerContainer}>
                            ...
                            <p className={loginStyles.headerSubtitle}>
                                Enter Your Credential to continue the experience
                            </p>
                        </div>
                        <form onSubmit={handeleSubmit}>
                            <div className={loginStyles.inputGroup}>
                                ...
                                <div className={loginStyles.inputContainer}>
                                    <input type="email" id='email' name='email' required value={formData.email} onChange={handleChange} className={loginStyles.input} placeholder='Your Email Address' />
                            ...
                            <div className={loginStyles.inputGroup}>
                                ...
                                <div className={loginStyles.inputContainer}>
                                    <input type={showPassword ? 'text' : 'password'} id='password' name='password' required value={formData.password} onChange={handleChange} className={loginStyles.input} placeholder='Enter Your Password' />
