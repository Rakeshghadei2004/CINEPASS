        ...
        <div className={styles2.pageContainer} style={fontStyles.cinzelFont}>
            <div className={styles2.maxWidthContainer}>
                ...
                <header className={styles2.headerContainer}>
                    <form onSubmit={(e) => e.preventDefault()} className={styles2.formContainer}>
                        <label className='sr-only' htmlFor="movie">Movie</label>
                        <select id="movie" value={selectedMovie} onChange={(e) => setSelectedMovie(e.target.value)} className={styles2.select}>
                            <option value="">All movies</option>
                            {movies.map((m) => (
                                <option value={m} key={m}> {m} </option>
                            ))}
                        </select>
                        <button type='button' onClick={clearFilter} title='Clear Movie' className={styles2.clearButton}>
                ...
                <section className={styles2.gridContainer}>
                    ...
                    {bookingsToShow.map((b) => {
                        ...
                        const audiDisplay = b.auditorium && b.auditorium.trim() ? b.auditorium : "Audi1";
                                ...
                                <div>
                                    ...
                                    <div className={styles2.detailContainer}>
                                        <div className={styles2.detailItem}>
                                            ...
                                            <div > {b.slot ? formatSlot(b.slot) : "Time Unavailable"}  </div>
                                        </div>

                                         <div className={styles2.detailItem}>
                                            <Ticket className={styles2.detailIcon} />
                                            <div className='text-sm text-green-300'>
                                                <span className={styles2.auditoriumLabel}>Auditorium</span>
                                                <span className={styles2.auditoriumValue}> {audiDisplay} </span>
                                            </div>
                                        </div>
